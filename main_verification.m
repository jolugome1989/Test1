...
Nio=2000; % Number of interfering objects
lambda_0=c0/fc; % Wavelength
bs=[0,0]; % Base station position
ue=[-200*lambda_0,0]; % User Equipment
pos_clusters=ue;
d_sc=lambda_0*5;
R=20000*lambda_0; % radius of the scatterers surrounding UE
rho_power=1;
...
for antenna_iter=1:4
Mt=2^antenna_iter; % Number Tx antennas
Mr=Mt; % Number Rx antennas
